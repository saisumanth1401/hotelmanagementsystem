<html>
	...
	$sql2 = "UPDATE confirmed_booking SET checkout='$checkout', days='$days', price='$row[13]' WHERE book_id='$bid'";
	mysqli_query($conn,$sql2);
	$sql3 = "UPDATE user_room_book SET checkout='$checkout', days='$days', price='$row[13]' WHERE book_id='$bid'";
